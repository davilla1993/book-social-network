...
public class BookController {
    ...
    @GetMapping("/borrowed")
    public ResponseEntity<PageResponse<HistoryBookResponse>> findAllBorrowedBooks(@RequestParam(name = "page", defaultValue = "0", required = false) int page,
                                                                                  @RequestParam(name = "size", defaultValue = "10", required = false) int size,
                                                                                  Authentication connectedUser) {
    ...
    @GetMapping("/returned")
    public ResponseEntity<PageResponse<HistoryBookResponse>> findAllReturnedBooks(@RequestParam(name = "page", defaultValue = "0", required = false) int page,
                                                                                  @RequestParam(name = "size", defaultValue = "10", required = false) int size,
                                                                                  Authentication connectedUser) {
    ...
    @PatchMapping("/borrow/return/{borrow-id}")
    ...
    @PatchMapping("/borrow/return/approve/{borrow-id}")
